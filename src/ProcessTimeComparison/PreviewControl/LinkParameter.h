...
//	腰 -> 右足先
	{  0.0f,  0.0f,  1.0f},	// RY  : 右股ヨー軸から右股ロール軸
	{  1.0f,  0.0f,  0.0f},	// RR1 : 右股ロール軸から右股ピッチ軸
	{  0.0f,  1.0f,  0.0f},	// RP1 : 右股ピッチ軸から右膝上ピッチ軸
	{  0.0f,  1.0f,  0.0f},	// RP2 : 右膝上ピッチ軸から右膝下ピッチ軸
	{  0.0f,  1.0f,  0.0f},	// RP3 : 右膝下ピッチ軸から右足首ピッチ軸
	{  0.0f,  1.0f,  0.0f},	// RP4 : 右足首ピッチ軸から右足首ロール軸
	{  1.0f,  0.0f,  0.0f},	// RR2 : 右足首ロール軸から右足先
	{  0.0f,  0.0f,  0.0f},	// RF  : 右足先
//	腰 -> 左足先
	{  0.0f,  0.0f,  1.0f},	// LY  : 左股ヨー軸から左股ロール軸
	{  1.0f,  0.0f,  0.0f},	// LR1 : 左股ロール軸から左股ピッチ軸
	{  0.0f,  1.0f,  0.0f},	// LP1 : 左股ピッチ軸から左膝上ピッチ軸
	{  0.0f,  1.0f,  0.0f},	// LP2 : 左膝上ピッチ軸から左膝下ピッチ軸
	{  0.0f,  1.0f,  0.0f},	// LP3 : 左膝下ピッチ軸から左足首ピッチ軸
	{  0.0f,  1.0f,  0.0f},	// LP4 : 左足首ピッチ軸から左足首ロール軸
	{  1.0f,  0.0f,  0.0f},	// LR2 : 左足首ロール軸から左足先
	{  0.0f,  0.0f,  0.0f},	// LF  : 左足先
//	肩中心 -> 右手先
	{  0.0f,  1.0f,  0.0f},	// RSP : 右肩ピッチ軸からロール軸
	{  1.0f,  0.0f,  0.0f},	// RSR : 右肩ロール軸から右腕先端
	{  0.0f,  0.0f,  0.0f},	// RH  : 右腕先端
//	肩中心 -> 左手先
	{  0.0f,  1.0f,  0.0f},	// LSP : 左肩ピッチ軸からロール軸
	{  1.0f,  0.0f,  0.0f},	// LSR : 左肩ロール軸から左腕先端
	{  0.0f,  0.0f,  0.0f},	// LH  : 左腕先端
};
...
//	腰 -> 頭
	...
	{  0.0f,   0.0f,   0.0f},	// HT  : 頭のチルト軸からカメラ (Acceliteは固定)
	{ 49.4f,   0.0f,  41.6f},	// HP  : 頭のパン軸からチルト軸
	{-10.0f,   0.0f,  29.7f},	// SH  : 肩中心から頭のパン軸
	{  0.0f,   0.0f, 126.5f},	// CS  : 腰から肩中心
	{  0.0f,   0.0f,   0.0f},	// CC  : 腰（基点）
//	腰 -> 右足先
	{  0.0f, -44.0f,   0.0f},	// RY  : 右股ヨー軸から右股ロール軸
	{  0.0f,   0.0f, -42.8f},	// RR1 : 右股ロール軸から右股ピッチ軸
	{ 15.0f,   0.0f,   0.0f},	// RP1 : 右股ピッチ軸から右膝上ピッチ軸
	{  0.0f,   0.0f,-108.0f},	// RP2 : 右膝上ピッチ軸から右膝下ピッチ軸
	{  0.0f,   0.0f, -41.0f},	// RP3 : 右膝下ピッチ軸から右足首ピッチ軸
	{  0.0f,   0.0f,-108.0f},	// RP4 : 右足首ピッチ軸から右足首ロール軸
	{  0.0f,   0.0f,   0.0f},	// RR2 : 右足首ロール軸から右足先
	{  0.0f,   0.0f, -43.5f},	// RF  : 右足先
//	腰 -> 左足先
	{  0.0f,  44.0f,   0.0f},	// LY  : 左股ヨー軸から左股ロール軸
	{  0.0f,   0.0f, -42.8f},	// LR1 : 左股ロール軸から左股ピッチ軸
	{ 15.0f,   0.0f,   0.0f},	// LP1 : 左股ピッチ軸から左膝上ピッチ軸
	{  0.0f,   0.0f,-108.0f},	// LP2 : 左膝上ピッチ軸から左膝下ピッチ軸
	{  0.0f,   0.0f, -41.0f},	// LP3 : 左膝下ピッチ軸から左足首ピッチ軸
	{  0.0f,   0.0f,-108.0f},	// LP4 : 左足首ピッチ軸から左足首ロール軸
	{  0.0f,   0.0f,   0.0f},	// LR2 : 左足首ロール軸から左足先
	{  0.0f,   0.0f, -43.5f},	// LF  : 左足先
//	肩中心 -> 右手先
	{  0.0f, -61.0f,   0.0f},	// RSP : 右肩ピッチ軸からロール軸
	{  0.0f, -17.9f, -41.8f},	// RSR : 右肩ロール軸から右腕先端
	{  0.0f, -30.0f,-247.6f},	// RH  : 右腕先端
//	肩中心 -> 左手先
	{  0.0f,  61.0f,   0.0f},	// LSP : 左肩ピッチ軸からロール軸
	{  0.0f,  17.9f, -41.8f},	// LSR : 左肩ロール軸から左腕先端
	{  0.0f,  30.0f,-247.6f},	// LH  : 左腕先端
};
